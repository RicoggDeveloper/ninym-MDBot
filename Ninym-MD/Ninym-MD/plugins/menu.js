 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya Ninym-MD ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 Ninym-MD"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Ninym - MD..."},
	]
    },{
...
*/
	...
	return conn.sendButton(m.chat, text, wm, img2, [["🥞MENU", _p + "menu"], ["🌸SCRIPT", _p + "sc"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "https://instagram.com/ricoxzz_?igshid=YmMyMTA2M2Y=",
                mediaType: "VIDEO",
